...
def test_is_login_page_info_detects_login_inputs():
    assert is_login_page_info({"url": "https://192.0.2.116/", "user_inputs": 1, "password_inputs": 1, "captcha_inputs": 1})


def test_is_login_page_info_detects_login_url():
    assert is_login_page_info({"url": "https://192.0.2.116/login.html", "user_inputs": 0, "password_inputs": 0, "captcha_inputs": 0})


def test_is_login_page_info_allows_authenticated_page():
    assert not is_login_page_info({"url": "https://192.0.2.116/main", "user_inputs": 0, "password_inputs": 0, "captcha_inputs": 0})
