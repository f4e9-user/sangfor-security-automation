...
def test_parse_cookie_header_splits_cookie_pairs():
    ...
    assert cookies == [
        {"name": "a", "value": "1", "domain": "192.0.2.118", "path": "/", "secure": True, "httpOnly": False, "sameSite": "Lax"},
        {"name": "sess_id", "value": "abc", "domain": "192.0.2.118", "path": "/", "secure": True, "httpOnly": False, "sameSite": "Lax"},
        {"name": "flag", "value": "x=y", "domain": "192.0.2.118", "path": "/", "secure": True, "httpOnly": False, "sameSite": "Lax"},
    ]
